...
state is frozen.
%TODO: fill in blanks; I forgot about this
...
\begin{figure}[!h]
    ...
    \caption{Transparency versus $Q^2$ for $\rho^0$ leptoproduction.
...
\begin{figure}[!h]
    ...
    \caption{Transparency versus $l_{fr}$ for $\rho^0$ leptoproduction from
             hydrogen, helium, and nitrogen targets.
...
\begin{figure}[!h]
    ...
    \end{subfigure}
    \caption{
             Transparency versus $Q^2$ for bins of coherence length $l_{fr}$
