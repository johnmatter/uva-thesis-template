...
This is also a scale where $\sigma_{tot}(pp)$ is relatively independent of $s$, as
shown in Fig%TODO: add the fig from the PDG Data Book
...
Previous measurements taken at SLAC, MIT Bates, and JLab for several nuclear
targets.
These transparency measurments, compiled in Fig%TODO: add the old quasielastic transparency data figure
are independent of $Q^2$ over the range of 2 to \SI{8}{\giga\electronvolt}.
...
Larson et al.~\cite{Larson_2006} use a semiclassical formula based on the eikonal approximation
and a parameterization of final state interactions in terms of an effective
cross section based on a quantum diffusion model~\cite{Farrar_1988}, in which
the strength of the interaction is proportional to the pion's propagation
...
$\rho^0$ leptoproduction were performed at Fermilab by the E665
collaboration (cite) and at CERN by the NMC collaboration (cite) using muon
beams of \SI{450}{\giga\electronvolt} and \SI{200}{\giga\electronvolt}
respectively.
...
The HERMES collaboration at DESY(cite) measured nuclear transparency as a
function of $Q^2$ and $l_{fr}$ for coherent and incoherent $\rho^0$
leptoproduction from \ch{^{14}N} using a \SI{27.5}{\giga\electronvolt} positon
beam.
...
function formalism, incorporating the effects of coherence length and CT(cite).
...
a \SI{5}{\giga\electronvolt} electron beam at JLab.
...
The $Q^2$ dependence of these transparency measurements, shown in Fig(ref) was
fit to a linear form $T=aQ^2+b$.
The slope $a$ was compared to the predictions of three models.


Kopeliovich-Nemchick-Schmidt (KNS) (cite) model blah blah blah


Frankfurt-Miller-Strikman (FMS) (cite) model blah blah blah


Gallmestier-Kaskulov-Mosel (GKM) (cite) model blah blah blah


All three models predict the slope and magnitude of the CLAS carbon
transparency measurements well within statistical precision.
The KNS and FMS models also predict the CLAS iron transparency measurements,
while the GKM model underestimates its magnitude.
