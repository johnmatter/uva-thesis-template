...
% % https://journals.aps.org/prd/pdf/10.1103/PhysRevD.56.2982
% % "Factorization for hard exclusive electroproduction of mesons in QCD"
% % Collins Frankfurt Strikman 1997
% "Our analysis also has direct implications for scattering off nuclei implying
% that color transparency phenomena should be present for exclusive production of
% leading mesons. We leave the discussion of this subject to a separate paper."

% % https://arxiv.org/pdf/hep-ph/9709336.pdf
% % "Proof of Factorization for Exclusive Deep-Inelastic Processes"
% % CFS 1997
% "The proof of cancellation of the soft gluon interactions is intimately related
% to the fact that the meson arises from a quark- antiquark pair generated by the
% hard scattering.
% Thus the pair starts as a small-size configuration and only substantially later
% grows to a normal hadronic size, in the meson."

% https://arxiv.org/pdf/hep-ph/9709499.pdf
% "Proof of Factorization for Diffractive Hard Scattering"
% Collins 1997

% % !!!!!! this seems like the strongest statement.
% % https://www.sciencedirect.com/science/article/abs/pii/S0375947499005734?via%3Dihub
% % "QCD Factorization theorems for DIS exclusive processes and inclusive diffraction: New probes of hadrons and nuclei"
% % Strikman 2000
% "Possibility to calculate these processes in perturbative QCD stems from the
% fundamental property of QCD - suppression of the cross section of interaction
% of color singlet dipoles with hadrons."
% ...
% "Qualitatively the factorization in these processes is due to the color
% screening/transparency - a small transverse size of \gamma^*_L to b\sim 1/Q selects
% small size (point-like) configurations in the meson."

CT is closely connected with QCD factorization
...
The amplitude of the exclusive hard process sketched in
