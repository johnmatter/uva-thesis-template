\section{Proton Absorption} \label{sec:proton_absorption}
...
Using our $Q^2 = \SI{11.5}{\giga\electronvolt\squared}$ runs and the cuts listed in
...
\begin{table}[h]
    ...
    \resizebox{1.0\textwidth}{!}{
        \begin{tabular}[t]{ l  l }
            ...
            $x'_{tar}$,$y'_{tar}$  &  Graphical cut on HMS xptar and yptar shown in Fig~\ref{fig:proton_absorption_plots} \\ \hline
...
The relevant histograms are shown in Fig~\ref{fig:proton_absorption_plots}.
...
Fig~\ref{fig:proton_absorption_cut_study} along with the mean and standard
