...
\begin{table}[h]
    ...
    \resizebox{1.0\textwidth}{!}{
        \begin{tabular}[t]{| l | l | l | r | r | r | r | r | r | r | r |}
            ...
            \multicolumn{10}{l}{\multirow{4}{*}{$^{a }$Nuclear interaction and collision lengths taken from PDG~\cite{pdg_nuclear_lengths}.}} \\
            \multicolumn{10}{l}{\multirow{4}{*}{$^{b }$The thicknesses of the wires are ``effective'' thicknesses, determined by the wire radii and cell spacings described in subsection~\ref{subsection:drift_chambers}.}}
        \end{tabular}
    } % resizebox
\end{table}
